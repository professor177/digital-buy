 ...
 * `price` is intentionally left as "BDT" — replace with a real amount,
 * e.g. "1,200 BDT" or "৳1,200", once you decide your pricing.
...
const sharedPlan = (
  ...
  quality: string,
  validity = "1 Month",
): OttPlan => ({ name, screens, quality, price: "BDT", validity });
