...
export default async function GamePlatformPage({
  ...
  if (platform === "ubisoft") {
    ...
    if (!rental) {
      return (
        <div className="wrap fade-up py-16 sm:py-24">
          <Link
          ...
          <div className="mt-8 flex flex-col items-center rounded-lg border border-dashed border-line bg-panel/50 px-6 py-16 text-center">
            <p className="text-2xl font-extrabold tracking-tight text-white">
              Ubisoft Library Pass
            </p>
            <p className="mt-3 max-w-md text-sm leading-6 text-fog">
              This rental is not listed yet. Check back soon, or message
              support and we will prioritize it.
            </p>
          </div>
        </div>
      );
