...
import { bdt, PRICE_COMING_SOON, type AccountMode } from "@/lib/shared";
import { BuyBox } from "@/components/purchase";
import { PackageArt, PlatformArt } from "@/components/platform-art";
  ...
  return (
    <div className="fade-up bg-screen">
      <div className="relative overflow-hidden border-b border-screen-line">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-screen via-screen/50 to-transparent" />
      ...
      <div className="wrap py-12">
        ...
        {packages.length === 0 ? (
          <div className="mt-6 flex flex-col items-center rounded-lg border border-dashed border-screen-line px-6 py-16 text-center">
            <p className="text-lg font-bold text-white">
              No packages added yet for {platform.name}
            </p>
            <p className="mt-1.5 max-w-sm text-sm leading-6 text-fog">
              Packages are being set up. Message support if you need this
              platform sooner.
            </p>
          </div>
        ) : (
            ...
            >
              <div className="relative aspect-[16/8] overflow-hidden">
                {pkg.thumbnail ? (
                  ...
                  <PackageArt slug={platform.slug} className="h-full w-full" />
                )}
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <div className="mt-4 flex items-center justify-between border-t border-screen-line pt-4">
                  ...
                  <span className="text-lg font-extrabold tracking-tight text-white">
                    {pkg.priceBdt != null ? bdt(pkg.priceBdt) : PRICE_COMING_SOON}
                  </span>
                </div>
                <div className="mt-4">
                  <BuyBox
