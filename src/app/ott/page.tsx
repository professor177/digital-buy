  ...
  return (
    <div className="fade-up bg-screen">
      <div className="wrap py-12 sm:py-16">
        ...
        {platforms.length === 0 ? (
          <div className="mt-10 flex flex-col items-center rounded-lg border border-dashed border-screen-line px-6 py-16 text-center">
            <Clapperboard size={28} className="text-fog/60" />
            <p className="mt-4 text-lg font-bold text-white">
              No platforms added yet
            </p>
            <p className="mt-1.5 max-w-sm text-sm leading-6 text-fog">
              Streaming platforms are being added to the catalog. Check back
              soon.
            </p>
          </div>
        ) : (
